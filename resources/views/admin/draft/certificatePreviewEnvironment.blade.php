...
@section('content')
    ...
    <style>
        #page-container {
            ...
            background-image: url("{{ asset('public/assets/certificates/draft/Environment.png') }}");
            letter-spacing: 0px;
        }
                            ...
                            <div class="card-body">
                                ...
                                <div id="page-container">
                                    <div id="canvasElement" class="pb-5">
                                        ...
                                        <div class="scope" style="height: 150px;margin-top: 70px;">
                                            <h5
    ...
    <script>
        $(document).ready(function() {
            var $certFileName = 'Environment Certificate.pdf';
            ...
            $("#btn-Convert-jpg").on('click', function() {
                ...
                $("#btn-Convert-jpg").attr("download", "Environment Certificate.jpg").attr("href",
                    newData);
            });
        });
    </script>
