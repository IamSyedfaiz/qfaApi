...
@section('content')
    ...
    <style>
        #page-container {
            ...
            background-image: url("{{ asset('public/assets/certificates/draft/qfsENERGY.png') }}");
            letter-spacing: 0px;
        }
                                ...
                                <div id="page-container">
                                    <div id="canvasElement" class="pb-5">
                                        ...
                                        <div class="bname" style="height: 60px;">
                                            <h1 style="margin-top:-50px;font-weight: 700;color:red">QFS MANAGEMENT
                                                SYSTEMS
                                                LLP</h1>
                                            <h3 style="margin-top: -20px;font-weight: 700;">This is to Certify
                                                that
                                                the Energy Management System of</h3>
                                            <h2 class="first"
