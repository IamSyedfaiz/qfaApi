...
@section('content')
    ...
    <style>
        #page-container {
            ...
            background-image: url("{{ asset('public/assets/certificates/draft/qfsOHS.png') }}");
            letter-spacing: 0px;
        }
                                ...
                                <div id="page-container">
                                    <div id="canvasElement" class="pb-5">
                                        ...
                                        <div class="bname" style="height: 60px;">
                                            <h1 style="margin-top:-50px;font-weight: 700;color:red;letter-spacing: 1px;">
                                                QFS MANAGEMENT
                                                SYSTEMS
                                                LLP</h1>
                                            <h4 style="margin-top: -20px;font-weight: 400;letter-spacing: -0.5px;">This is
                                                to
                                                Certify
                                                that
                                                the Occupational Health & Safety Management System of</h4>
                                            <h2 class="first"
                                            ...
                                            <h4 style="margin-top: -10px;font-weight: 700;font-size: 20px">Has been found to
                                                be of the
                                                Occupational Health & Safety Management Standard</h4>
                                        </div>
