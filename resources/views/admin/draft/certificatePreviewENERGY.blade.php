...
@section('content')
    ...
    <style>
        #page-container {
            ...
            background-image: url("{{ asset('public/assets/certificates/draft/ENERGY.png') }}");
            letter-spacing: 0px;
            font-family: times;
    ...
    <script>
        $(document).ready(function() {
            var $certFileName = 'Energy Certificate.pdf';
            ...
            $("#btn-Convert-jpg").on('click', function() {
                ...
                $("#btn-Convert-jpg").attr("download", "Energy Certificate.jpg").attr("href",
                    newData);
            });
        });
    </script>
