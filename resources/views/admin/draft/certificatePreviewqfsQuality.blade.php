...
@section('content')
    ...
    <style>
        #page-container {
            ...
            background-image: url("{{ asset('public/assets/certificates/draft/qfsQuality.png') }}");
            letter-spacing: 0px;
            font-family: times;
        }
                                ...
                                <div id="page-container">
                                    <div id="canvasElement" class="pb-5">
                                        ...
                                        <div class="bname" style="height: 60px;">
                                            <h1
                                                style="margin-top:-50px;font-weight: 700;color:red;letter-spacing: 1px;font-family: ARIAL;">
                                                QFS MANAGEMENT
                                                SYSTEMS
                                                LLP</h1>
                                            <h4
                                                style="margin-top: -10px;font-weight: 400;letter-spacing: -0.5px;font-family: ARIAL;">
                                                This is
                                                to
                                                Certify
                                                that
                                                the Quality Management System of</h4>
                                            <h2 class="first"
                                                style="letter-spacing: 0px; font-weight: 600;padding-top: 0px;margin-top:-10px;">
                                                {{ $data->business_name }}</h2>
                                            <p class="second"
                                                style="letter-spacing: 0px;padding-top: 10px;font-weight: 700;font-size: 18px">
                                                {{ $data->business_name_secondary }}</p>
                                            <h4 style="margin-top: -10px;font-size: 22px;font-family: ARIAL;">
                                                Has been found to
                                                be of the
                                                Quality Management Standard</h4>
                                        </div>

                                        <div class="standard" style="padding-top: 170px; height: 80px;">
                                            <h3 style="font-weight: 700;color:#842057;font-size: 36px">
                                                {{ $data->standard_name }}</h3>
                                            {{-- <h3 style="margin-top: -20px;font-weight: 700;color:#842057">
                                        ...
                                        <div class="scope" style="height: 150px;margin-top:50px;">
                                            ...
                                            <h6
                                                style="margin-top: -30px;font-size: 13px; font-weight: 600;letter-spacing: 0px;padding-top: 20px">
                                        ...
                                        <div
                                            ...
                                            <div style="text-align: start;font-family: ARIAL;">
                                                <h5 style="letter-spacing: 0px; font-size: 18px">Certificate Number:
                                                    <span style="font-family: times;">00/00/000/0000</span>
                                                </h5>
