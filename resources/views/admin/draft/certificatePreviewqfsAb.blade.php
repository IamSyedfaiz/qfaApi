...
@section('content')
    ...
    <style>
        #page-container {
            ...
            background-image: url("{{ asset('public/assets/certificates/draft/qfsab.png') }}");
            letter-spacing: 0px;
        }
                                    ...
                                    <div id="canvasElement" class="pb-5">
                                        ...
                                        <div class="bname" style="height: 60px;">
                                            <h1 style="margin-top:-50px;font-weight: 700;color:red;letter-spacing: 1px;">
                                                ...
                                                SYSTEMS
                                                LLP</h1>
                                            <h3 style="margin-top: -20px;font-weight: 700;">This is to Certify
                                                that
                                                the Anti-bribery Management System of</h3>
                                            <h2 class="first"
                                            ...
                                            <h4 style="margin-top: -10px;font-weight: 700;font-size: 22px">Has been found to
                                                be of the
                                                Anti-bribery Management Standard</h4>
                                        </div>
