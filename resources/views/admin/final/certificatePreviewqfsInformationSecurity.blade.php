...
@section('content')
    ...
    <style>
        #page-container {
            ...
            background-image: url("{{ asset('public/assets/certificates/final/qfsInformationSecurity.png') }}");
            letter-spacing: 0px;
            font-family: times;
                                ...
                                <div id="page-container">
                                    <div id="canvasElement" class="pb-5">
                                        ...
                                        <div class="bname" style="height: 60px;">
                                            <h1 style="margin-top:-40px;font-weight: 700;color:red;font-family: ARIAL;">QFS
                                                MANAGEMENT
                                                SYSTEMS
                                                LLP</h1>
                                            <h3 style="margin-top: -20px;font-weight: 700;font-family: ARIAL;">This is to
                                                Certify
                                                that
                                                the Information Security Management System of</h3>
                                            <h2 class="first"
                                            ...
                                            <h4
                                                ...
                                                Has been found to
                                                be of the
                                                Information Security Management Standard</h4>
                                        </div>
                                        ...
                                        <div style="margin-top: 38px; margin-left: -50px;">
                                            <span style="font-family: times;">
                                                {{ \Carbon\Carbon::parse($data->date_initial)->format('d-m-Y') }}</span>
                                        </div>
                                        <br>
    ...
    <script>
        $(document).ready(function() {
            var $certFileName = 'Information Security Certificate.pdf';
            ...
            $("#btn-Convert-jpg").on('click', function() {
                ...
                $("#btn-Convert-jpg").attr("download", "Information Security Certificate.jpg").attr("href",
                    newData);
            });
        });
    </script>
