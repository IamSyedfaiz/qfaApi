...
@section('content')
    ...
    <style>
        #page-container {
            ...
            background-image: url("{{ asset('public/assets/certificates/final/qfsab.png') }}");
            letter-spacing: 0px;
            font-family: times;
    ...
    <script>
        $(document).ready(function() {
            var $certFileName = 'Anti-bribery Certificate.pdf';
            ...
            $("#btn-Convert-jpg").on('click', function() {
                ...
                $("#btn-Convert-jpg").attr("download", "Anti-bribery Certificate.jpg").attr("href",
                    newData);
            });
        });
    </script>
