...
@section('content')
    ...
    <style>
        #page-container {
            ...
            background-image: url("{{ asset('public/assets/certificates/final/qfsQuality.png') }}");
            letter-spacing: 0px;
            font-family: times;
                                    ...
                                    <div id="canvasElement" class="pb-5">
                                        ...
                                        <div class="bname" style="height: 60px;">
                                            ...
                                            <h3 style="margin-top: -20px;font-weight: 700;font-family: ARIAL;">This is to
                                                Certify
                                                that
                                                the Quality Management System of</h3>
                                            <h2 class="first"
    ...
    <script>
        $(document).ready(function() {
            var $certFileName = 'Quality Certificate.pdf';
            ...
            $("#btn-Convert-jpg").on('click', function() {
                ...
                $("#btn-Convert-jpg").attr("download", "Quality Certificate.jpg").attr("href",
                    newData);
            });
        });
    </script>
