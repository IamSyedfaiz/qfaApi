...
@section('content')
    ...
    <style>
        #page-container {
            ...
            background-image: url("{{ asset('public/assets/certificates/final/ITS.png') }}");
            letter-spacing: 0px;
            font-family: times;
                                ...
                                <div id="page-container">
                                    <div id="canvasElement" class="pb-5">
                                        ...
                                        @if ($data->certificate_status == 'F')
                                            <p style="margin-top: 5px ;margin-left: 2px;  font-weight: 700">
                                                {{ @$data->certificate_number }}</p>

                                            <div
                                                style="margin: 65px 20px; display: flex; justify-content: space-between;font-weight: 700;">
