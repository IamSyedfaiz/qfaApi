...
@section('content')
    ...
    <style>
        #page-container {
            ...
            background-image: url("{{ asset('public/assets/certificates/final/cert1.png') }}");
            letter-spacing: 0px;
        }
                                ...
                                <div id="page-container">
                                    <div id="canvasElement" class="pb-5">
                                        ...
                                        <div class="standard" style="padding-top: 200px; height: 100px;">
                                            <h3 style="font-weight: 700;color:#2F2482">
                                                {{ $data->standard_name }}</h3>
                                            <h3 style="margin-top: -20px;font-weight: 700;color:#2F2482">
                                                ({{ $data->standard_description }})</h3>
                                        </div>
                                        <div class="scope" style="height: 150px;margin-top: 80px;">
                                            <h5
                                                style="margin-top: 10px; font-weight: 600;letter-spacing: 1px;padding-top: 50px">
                                                {{ $data->scope_registration }}
                                            </h5>
                                        </div>
                                        @if ($data->certificate_status == 'F')
                                            <p style="margin-top: 4px ;margin-left: 40px;  font-weight: 700">
                                                {{ @$data->certificate_number }}</p>

                                            <div
                                                style="margin: 50px 20px; display: flex; justify-content: space-between;font-weight: 700;">
