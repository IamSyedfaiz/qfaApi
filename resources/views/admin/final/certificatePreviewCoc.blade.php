...
@section('content')
    ...
    <style>
        #page-container {
            ...
            background-image: url("{{ asset('public/assets/certificates/cocDraft.png') }}");
            letter-spacing: 0px;
        }
                                ...
                                <div id="page-container">
                                    <div id="canvasElement" class="pb-5">
                                        <div class="bname" style="height: 60px;">
                                            <h2 class="first" style="font-weight: 700; ">
                                                {{ $data->business_name }}</h2>
                                            <p class="second" style="text-align: start; font-size: 17px;">
                                        ...
                                        <div class="standard" style="padding-top: 230px; height: 150px; ">
                                        ...
                                        <div class="scope" style="height: 100px;">
                                            <div style="margin-top: 70px;text-align: start;">For the following scope:
                                                <span style="font-weight: 600;">{{ $data->scope_registration }}</span>
                                            </div>
                                        </div>
                                        @if (@$data->certificate_status == 'F')
                                            <p
                                                style="margin-top:-60px ;padding-left:155px ; font-weight: 600;text-align: start;">
                                                {{ @$data->certificate_number }} asdAD
                                            </p>
                                            <div style="margin-top: -22px;">
                                                ...
                                                <p
                                                    style="margin-top: -60px;padding-right: 15px; line-height: 1px; text-align: end;">
                                                    {{ @$data->second_surveillance_audit }}</p>
                                                <p
                                                    style="padding-top: 2px;padding-right: 15px; line-height: 1px; text-align: end;">
                                                    {{ @$data->certification_due_date }}</p>
                                            </div>
                                        @else
                                            <p
                                                style="margin-top:-10px ;padding-left:155px ; font-weight: 600;text-align: start;">
                                                OR-BV-XXXX
                                            </p>
                                            <div style="margin-top: -22px;">
                                                <p
                                                ...
                                                <p
                                                    ...
                                                    XXXX</p>
                                                <p
                                                    style="margin-top: -60px;padding-right: 60px; line-height: 1px; text-align: end;">
                                                    XXXX</p>
                                                <p
                                                    style="padding-top: 2px;padding-right: 60px; line-height: 1px; text-align: end;">
                                                    XXXX</p>
                                            </div>
                                        @endif
                                        <br>
