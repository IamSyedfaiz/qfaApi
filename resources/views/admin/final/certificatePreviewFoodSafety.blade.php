...
@section('content')
    ...
    <style>
        #page-container {
            ...
            background-image: url("{{ asset('public/assets/certificates/final/FoodSafety.jpg') }}");
            letter-spacing: 0px;
            font-family: times;
        }
                            ...
                            <div class="card-body">
                                ...
                                <div id="page-container">
                                    <div id="canvasElement" class="pb-5">
                                        ...
                                        <div class="scope" style="height:130px; margin-top:80px;">
                                            <h5
                                                style="font-weight: 600;letter-spacing: 1px;padding-top: 50px ;line-height: 20px">
                                                {{ $data->scope_registration }}
                                            </h5>
                                        </div>
                                        @if ($data->certificate_status == 'F')
                                            <p style="margin-top: 8px ;margin-left: 80px;font-weight: 700">
                                                {{ @$data->certificate_number }}</p>

                                            <div
                                                style="margin: 70px 20px; display: flex; justify-content: space-between;font-weight: 700;">
                                                <p style="line-height: 2px">{{ @$data->date_initial }}</p>
